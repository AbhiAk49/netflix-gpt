    ...
    <div className="w-screen aspect-video p-3 absolute top-0 bg-gradient-to-r from-black pt-[15rem] pl-20">
      <div>
        ...
        <div className="flex justify-between">
          ...
          {muted !== null && (
            <button
              className="bg-slate-100 bg-opacity-10 text-white p-2 hover:shadow-slate-800 m-2 mt-4 -translate-x-[3.25rem] z-30 rounded-full opacity-70 border-white border"

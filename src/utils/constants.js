...
export const BASE_TMDB_PATH = USE_PROXY === 'true' ? PROXY_TMDB_PATH : DEF_TMDB_PATH;
...
export const TMDB_NOW_PLAYING_API = `${BASE_TMDB_PATH}/3/movie/now_playing`;

export const TMDB_IMG_BASE_URL = "https://image.tmdb.org/t/p/original/";

export const TMDB_MOVIE_VIDEO_BY_ID = (movie_id) =>
  `${BASE_TMDB_PATH}/3/movie/${movie_id}/videos?language=${TMDB_LANG}`;
...
export const TMDB_TOP_RATED_MOVIES = `${BASE_TMDB_PATH}/3/movie/top_rated?language=${TMDB_LANG}&page=1`;

export const TMDB_POPULAR_MOVIES = `${BASE_TMDB_PATH}/3/movie/popular?language=${TMDB_LANG}&page=1`;

export const TMDB_TRENDING_WK_MOVIES = `${BASE_TMDB_PATH}/3/trending/movie/week?language=${TMDB_LANG}`;

export const TMDB_MOVIE_SEARCH = (query) => `${BASE_TMDB_PATH}/3/search/movie?query=${query}&include_adult=false&language=en-US`;

//remove these --> move to env only
export const OPEN_AI_KEY = process.env.REACT_APP_OPEN_AI_KEY;

//process.env.REACT_APP_TMBD_TOKEN
